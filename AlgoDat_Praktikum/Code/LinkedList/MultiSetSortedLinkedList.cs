...
{
    class MultiSetSortedLinkedList : List, IMultiSetSorted<Node>
    {
        //hier dürfen gleiche elemente mehrmals vorkommen und müssen sortiert sein
        public void MultiSetSortedHandler()
        {
            sorted = true;
            do
            {
                Console.WriteLine("\n\nDu hast eine multi sortierte verkettete Liste ausgewählt!");
